...
export const ElasticsearchNode: NodeDefinition = {
  ...
  parameters: [
    {
      ...
      options: [
        ...
        { name: 'SQL Query', value: 'sql', description: 'Execute SQL query (requires license)' },
      ],
    ...
    },
    {
      ...
      type: 'json',
      default: '{\n  "query": {\n    "match_all": {}\n  }\n}',
      description: 'Search query in Elasticsearch Query DSL',
      displayOptions: {
        show: {
          operation: ['search'],
        },
  ...
  documentationUrl: 'https://docs.twiddle.io/nodes/elasticsearch',
};
