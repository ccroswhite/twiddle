...
export const ValkeyNode: NodeDefinition = {
  type: 'twiddle.valkey',
  displayName: 'Valkey',
  ...
  parameters: [
    {
      ...
      options: [
        ...
        { name: 'Execute Command', value: 'executeCommand', description: 'Execute raw command' },
      ],
    ...
    },
    {
      ...
      displayOptions: { show: { operation: ['set', 'hset'] } },
    },
    {
      name: 'command',
      displayName: 'Command',
      ...
      displayOptions: { show: { operation: ['executeCommand'] } },
    },
    {
      name: 'database',
  ...
  documentationUrl: 'https://docs.twiddle.io/nodes/valkey',
};
